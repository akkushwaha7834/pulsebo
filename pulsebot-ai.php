                ...
                <div class="about-pulsebot-ai-left text-center">
                    ...
                    <form action="">
                        <select class="form-select" aria-label="Default select example">
                            ...
                            <option value="FREE Trial (Demo MT4 Account)">FREE Trial (Demo MT4 Account)</option>
                            <option value="Monthly $59">Monthly $59</option>
                            <option value="Yearly $468">Yearly $468</option>
                            <option value="Lifetime $990">Lifetime $990</option>
                            <option value="6Month $294" disabled="disabled">6Month $294</option>
                        </select>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md -6">
                <div class="key_feature_box text-center h-100">
                    <h2 class="fs-1">1 </h2>
                    <h2 class="fs-3">Requirements </h2>
                    <p class="text-light">Choose your plan and complete your order process </p>
                </div>
            </div>
            <div class="col-lg-4 col-md -6">
                <div class="key_feature_box text-center h-100">
                    <h2 class="fs-1">2 </h2>
                    <h2 class="fs-3">Requirements </h2>
                    <p class="text-light">We will send your EA by your license for primary version through email just
                        save the file in your pc or laptop</p>
                </div>
            </div>
            <div class="col-lg-4 col-md -6">
                <div class="key_feature_box text-center h-100">
                    <h2 class="fs-1">3 </h2>
                    <h2 class="fs-3">Requirements </h2>
                    <p class="text-light">Drag and drop the file in the Expert folder of your metatrader 4 app, your bot

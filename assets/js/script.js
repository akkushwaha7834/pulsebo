...
if (window.location == "http://localhost/pulsebo/pricing.php" || window.location == "http://localhost/pulsebo/pulsebot-ai.php" || window.location == "http://localhost/pulsebo/pulsebot-pro.php" || window.location == "http://localhost/pulsebo/pricing.php" || window.location == "http://localhost/pulsebo/become-an-affiliate.php" || window.location == "http://localhost/pulsebo/blog.php" || window.location == "http://localhost/pulsebo/about-us.php" || window.location == "http://localhost/pulsebo/contact-us.php" || window.location == "http://localhost/pulsebo/pulsebot-webinar.php") {
